...
with st.sidebar:
    ...
    try:
        ...
        st.error("EURI_API_KEY not configured. Please set it in Streamlit Secrets or environment.")
        st.caption("Admin: In Streamlit Cloud, open Settings → Secrets and add EURI_API_KEY.")
        st.stop()
